  ...
  const onSubmit = async (values: z.infer<typeof signUpFormSchema>) => {
    ...
    try {
      ...
      if (res.success === true) {
        ...
        router.push(
          `/auth/verify-email?token=${res?.data?.accessToken}&type=signup`,
        );
      } else {
        ...
        <Form {...signUpForm}>
          ...
          >
            ...
            {error &&
              (error == "User already exists" ? (
                <p className="text-center">
                  ...
                  <Link href="/auth/login" className="text-[#00998E] underline">
                    logging in.
                  </Link>
                </p>
              ) : (
            ...
            <div className="flex justify-between items-center">
              <Link href="/auth/login" className="text-sm text-[#485150]">
                Have an account?
              </Link>
              <Link
                href="/auth/login"
